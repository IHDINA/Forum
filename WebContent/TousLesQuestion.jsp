		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" >Tous les questions</a>
                </div>
                    ...
                    <div class="col-lg-5 col-md-5">
                        ...
                        <div style="max-height: 555px; height: 555px ; overflow-y: scroll;" >
                            ...
                            <%
								...
								conn=Conn.getCon();
                            requete= "SELECT q.idQ,q.question,c.Cat,u.Nom,u.Prenom,q.Date FROM question q,user u,categorie c WHERE q.userId=u.userId and c.idCat=q.Categorie ORDER BY Date DESC";
								try{
